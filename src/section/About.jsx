        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='space-y-8'>
            ...
            animation-delay-200'>
              ...
              <p>
                I specialize in React, Node.js, and Javascript, building everything 
              ...
              <p>
                When I'm not coding, you will find me exploring new technologies
          ...
          <div className='grid sm:grid-cols-2 gap-6'>
            {highlights.map((item, idx) => (
              <div key={idx} 
                ...
                items-center justify-center mb-4 hover:bg-primary/20 transition-all
                duration-300'>
